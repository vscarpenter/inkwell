...
function buildJson({ vars, version }) {
  ...
  const json = {
    _meta: {
      ...
      palettes: [
        { name: "Indigo & Cloud", file: "inkwell-tokens.css", canonical: true },
        { name: "Clay", file: "variants/clay.css" },
        { name: "Sage & Stone", file: "variants/sage.css" },
        { name: "Burgundy & Bone", file: "variants/burgundy.css" },
        { name: "Azure & Ink", file: "variants/azure.css" },
      ],
      version,
